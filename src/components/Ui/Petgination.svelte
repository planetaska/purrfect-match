...
<nav class="flex items-center justify-between border-t border-base-300 px-4 sm:px-0">
	<div class="-mt-px flex w-0 flex-1">
		<a href={prev_link} tabindex="0" class="inline-flex items-center border-t-2 border-transparent pt-4 pr-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
	...
	<div class="hidden md:-mt-px md:flex">
		{#each pagi_links as link}
			...
			{:else if link === pagi.current_page}
				<a href={`${page.url.pathname}?${params}&page=${link}`} tabindex="0"
	...
	<div class="-mt-px flex w-0 flex-1 justify-end">
		<a href={next_link} tabindex="0" class="inline-flex items-center border-t-2 border-transparent pt-4 pl-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
			Next
