	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto max-w-2xl lg:mx-0">
			<h2 class="text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl">
				Find a pet
				{#if $zip !== ''}
				<span class="text-sm font-normal tracking-normal">near: {$zip}</span>
				{/if}
			</h2>
			<p class="mt-6 text-lg/8 text-gray-600">Select a category</p>
		</div>
		<ul role="list" class="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
			<li>
				<a href="/pets/cats">
				<img class="aspect-3/2 w-full rounded-2xl object-cover" src="/images/layout/cats/cats-17.jpg" alt="">
				<h3 class="mt-6 text-lg/8 font-semibold tracking-tight text-gray-900">Cats</h3>
			...
			<li>
				...
				<h3 class="mt-6 text-lg/8 font-semibold tracking-tight text-gray-900">Dogs</h3>
			...
			<li>
				...
				<h3 class="mt-6 text-lg/8 font-semibold tracking-tight text-gray-900">Rabbits</h3>
			...
			<li>
				...
				<h3 class="mt-6 text-lg/8 font-semibold tracking-tight text-gray-900">Birds</h3>
