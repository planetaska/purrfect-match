<div class="grow bg-base-100">
	<div class="relative bg-gray-900">
		...
		<div aria-hidden="true" class="absolute inset-0 overflow-hidden">
			<img src="/images/layout/splash/purr-03.jpg" alt="" class="size-full object-cover">
		</div>
		...
		<div class="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-64 lg:px-0">
			...
			<a href="https://petfinder.com" class="mt-8 inline-block rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-gray-900 hover:bg-gray-100">
				Visit PetFinder.com
			</a>
		</div>
	</div>
