				...
				<div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
					<div class="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
						<h1 class="text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-7xl">
							Because every happy tail begins with the right match.
						</h1>
						<p
							class="mt-8 text-lg font-light text-pretty text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none"
						>
							<span class="font-medium italic">Find your perfect companion, not just any pet.</span>
							Every pet deserves their perfect human, and every human deserves their perfect pet. At
							Purrfect Match, we've reimagined pet adoption by focusing on what truly matters – compatibility.
						</p>
						<div class="mt-10 flex items-center gap-x-2">
							<label class="input">
								...
								<form method="POST" action="/pets">
									...
									<input type="search" name="zipcode" class="grow" placeholder="Zip code" />
								</form>
							</label>
							<a
								href="#"
					...
					>
						...
						>
							<div class="relative">
								<img
									src="/images/layout/splash/purr-01.jpg"
									alt=""
						...
						<div class="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36">
							<div class="relative">
								<img
									src="/images/layout/splash/purr-02.jpg"
									alt=""
									class="aspect-2/3 w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
								/>
								<div
							...
							<div class="relative">
								<img
									src="/images/layout/splash/purr-04.jpg"
									alt=""
									class="aspect-2/3 w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
								/>
								<div
						...
						<div class="w-44 flex-none space-y-8 pt-32 sm:pt-0">
							<div class="relative">
								<img
									src="/images/layout/splash/purr-13.jpg"
									alt=""
									class="aspect-2/3 w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
								/>
								<div
							...
							<div class="relative">
								<img
									src="/images/layout/splash/purr-15.jpg"
									alt=""
									class="aspect-2/3 w-full rounded-xl bg-gray-900/5 object-cover shadow-lg"
								/>
								<div
